...
<main id="main" role="main">
    ...
    <header class="page-head wow fadeInUp" data-wow-delay="0.6s" style="background-image: url(/blog/images/img52.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h1>搜寻 思索</h1>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="main-header">
                    <strong class="title">以下为关键字 "{{ $key }}" 的搜索结果</strong>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    @foreach($data as $val)
                        <article class="post-block wow fadeInUp" data-wow-delay="0.6s">
                            <div class="post-holder">
                                ...
                                <footer>
                                    <strong class="text comment-count"><span class="icon ico-comment"></span><a href="#">X条评论</a></strong>
